...
public sealed partial class AppEngine : IAsyncDisposable
{
    ...
    public void Start(bool serial=true,bool wifiTelemetry=true)
    {
        ...
        try{
            ...
            RecordOperational(new(DateTimeOffset.UtcNow,OperationalSeverity.Info,OperationalDomain.Host,"HOST_STARTED","OpsDeck host started: M6.13-A / EdgeNode Read-Only"));
        ...
        log.Event("host_started",new{version="M6.13-A",serial,accounts=Accounts.Count(a=>a.Profile.Enabled)});
    }
